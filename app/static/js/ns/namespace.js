    ...
    namespace = {
        ...
        registerUser: function () {
            ...
            $(registerBtn).click(function (event) {
                ...
                } else if (password.val() !== confPass.val() || !password.val() || !confPass.val() || !username.val() || !phone.val()) {
                    $(instructions).html('Username, Password, and Confirm Password must not be empty and passwords must match').css('color', 'red');
